...
declare const app: {
  ...
  configure: {
    generative: {
      ...
      >;
      palm: (
        config?: import('./collections/index.js').GenerativePaLMConfig | undefined
      ) => import('./collections/index.js').ModuleConfig<
        'generative-palm',
        import('./collections/index.js').GenerativePaLMConfig | undefined
      >;
    };
    reranker: {
      cohere: (
  ...
  reconfigure: {
    ...
    vectorizer: {
      update: <N_21 extends string | undefined, I_21 extends string>(
        options: import('./collections/index.js').VectorizerUpdateOptions<N_21, I_21>
      ) => import('./collections/index.js').VectorConfigUpdate<N_21, I_21>;
    };
    replication: (options: {
      asyncEnabled?: boolean | undefined;
      factor?: number | undefined;
