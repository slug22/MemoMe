...
export declare const vectorizer: {
  ...
  ref2VecCentroid: <N_5 extends string | undefined = undefined, I_5 extends string = 'hnsw'>(
    opts: ConfigureNonTextVectorizerOptions<N_5, I_5, 'ref2vec-centroid'>
  ) => VectorConfigCreate<never, N_5, I_5, 'ref2vec-centroid'>;
  /**
  ...
  text2VecAWS: <T, N_6 extends string | undefined = undefined, I_6 extends string = 'hnsw'>(
    opts: ConfigureTextVectorizerOptions<T, N_6, I_6, 'text2vec-aws'>
  ) => VectorConfigCreate<PrimitiveKeys<T>, N_6, I_6, 'text2vec-aws'>;
  /**
  ...
  text2VecAzureOpenAI: <T_1, N_7 extends string | undefined = undefined, I_7 extends string = 'hnsw'>(
    opts: ConfigureTextVectorizerOptions<T_1, N_7, I_7, 'text2vec-azure-openai'>
  ) => VectorConfigCreate<PrimitiveKeys<T_1>, N_7, I_7, 'text2vec-azure-openai'>;
  /**
  ...
  text2VecCohere: <T_2, N_8 extends string | undefined = undefined, I_8 extends string = 'hnsw'>(
    opts?:
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_2>, N_8, I_8, 'text2vec-cohere'>;
  /**
  ...
  text2VecContextionary: <T_3, N_9 extends string | undefined = undefined, I_9 extends string = 'hnsw'>(
    opts?:
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_3>, N_9, I_9, 'text2vec-contextionary'>;
  /**
   ...
   */
  text2VecDatabricks: <T_4, N_10 extends string | undefined = undefined, I_10 extends string = 'hnsw'>(
    opts: ConfigureTextVectorizerOptions<T_4, N_10, I_10, 'text2vec-databricks'>
  ) => VectorConfigCreate<PrimitiveKeys<T_4>, N_10, I_10, 'text2vec-databricks'>;
  /**
   ...
   */
  text2VecGPT4All: <T_5, N_11 extends string | undefined = undefined, I_11 extends string = 'hnsw'>(
    opts?:
      | (import('../index.js').Text2VecGPT4AllConfig & {
          name?: N_11 | undefined;
          sourceProperties?: PrimitiveKeys<T_5>[] | undefined;
          vectorIndexConfig?:
            | import('../index.js').ModuleConfig<I_11, VectorIndexConfigCreateType<I_11>>
            | undefined;
        })
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_5>, N_11, I_11, 'text2vec-gpt4all'>;
  /**
   ...
   */
  text2VecHuggingFace: <T_6, N_12 extends string | undefined = undefined, I_12 extends string = 'hnsw'>(
    opts?:
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_6>, N_12, I_12, 'text2vec-huggingface'>;
  /**
   ...
   */
  text2VecJina: <T_7, N_13 extends string | undefined = undefined, I_13 extends string = 'hnsw'>(
    opts?:
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_7>, N_13, I_13, 'text2vec-jina'>;
  /**
   ...
   */
  text2VecMistral: <T_8, N_14 extends string | undefined = undefined, I_14 extends string = 'hnsw'>(
    opts?:
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_8>, N_14, I_14, 'text2vec-mistral'>;
  /**
   ...
   */
  text2VecOctoAI: <T_9, N_15 extends string | undefined = undefined, I_15 extends string = 'hnsw'>(
    opts?:
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_9>, N_15, I_15, 'text2vec-octoai'>;
  /**
   ...
   */
  text2VecOpenAI: <T_10, N_16 extends string | undefined = undefined, I_16 extends string = 'hnsw'>(
    opts?:
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_10>, N_16, I_16, 'text2vec-openai'>;
  /**
   ...
   */
  text2VecOllama: <T_11, N_17 extends string | undefined = undefined, I_17 extends string = 'hnsw'>(
    opts?:
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_11>, N_17, I_17, 'text2vec-ollama'>;
  /**
   ...
   */
  text2VecPalm: <T_12, N_18 extends string | undefined = undefined, I_18 extends string = 'hnsw'>(
    opts?:
      | (import('../index.js').Text2VecPalmConfig & {
          name?: N_18 | undefined;
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_12>, N_18, I_18, 'text2vec-palm'>;
  /**
   ...
   */
  text2VecTransformers: <T_13, N_19 extends string | undefined = undefined, I_19 extends string = 'hnsw'>(
    opts?:
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_13>, N_19, I_19, 'text2vec-transformers'>;
  /**
   ...
   */
  text2VecVoyageAI: <T_14, N_20 extends string | undefined = undefined, I_20 extends string = 'hnsw'>(
    opts?:
      ...
      | undefined
  ) => VectorConfigCreate<PrimitiveKeys<T_14>, N_20, I_20, 'text2vec-voyageai'>;
};
