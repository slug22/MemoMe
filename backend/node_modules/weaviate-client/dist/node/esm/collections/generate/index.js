  ...
  hybrid(query, generate, opts) {
    return this.hybridSearch(opts)
      .then(({ search, supportsTargets }) =>
        search.withHybrid(
          Object.assign(
            Object.assign({}, Serialize.hybrid(Object.assign({ query, supportsTargets }, opts))),
            {
              generative: Serialize.generative(generate),
              groupBy: Serialize.isGroupBy(opts) ? Serialize.groupBy(opts.groupBy) : undefined,
            }
        ...
        toBase64FromMedia(image).then((image) =>
          search.withNearImage(
            Object.assign(
              Object.assign(
                {},
                Serialize.nearImage(Object.assign({ image, supportsTargets }, opts ? opts : {}))
              ),
              {
                generative: Serialize.generative(generate),
                groupBy: Serialize.isGroupBy(opts) ? Serialize.groupBy(opts.groupBy) : undefined,
    ...
    return this.nearSearch(opts)
      .then(({ search, supportsTargets }) =>
        search.withNearObject(
          Object.assign(
            Object.assign({}, Serialize.nearObject(Object.assign({ id, supportsTargets }, opts ? opts : {}))),
            {
              generative: Serialize.generative(generate),
              groupBy: Serialize.isGroupBy(opts) ? Serialize.groupBy(opts.groupBy) : undefined,
            }
      ...
      .then(({ search, supportsTargets }) =>
        search.withNearText(
          Object.assign(
            Object.assign(
              {},
              Serialize.nearText(Object.assign({ query, supportsTargets }, opts ? opts : {}))
            ),
            {
              generative: Serialize.generative(generate),
              groupBy: Serialize.isGroupBy(opts) ? Serialize.groupBy(opts.groupBy) : undefined,
      ...
      .then(({ search, supportsTargets }) =>
        search.withNearVector(
          Object.assign(
            Object.assign(
              {},
              Serialize.nearVector(Object.assign({ vector, supportsTargets }, opts ? opts : {}))
            ),
            {
              generative: Serialize.generative(generate),
              groupBy: Serialize.isGroupBy(opts) ? Serialize.groupBy(opts.groupBy) : undefined,
